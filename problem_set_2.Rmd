...
-- I don't see it as a double, just a date. 
...
today_day = wday(today, label = TRUE, abbr = TRUE)
today_day
...
```{r co2_percentage}
# your code here
avg_perc = avg_co2 / (280 + avg_co2) * 100
summary(avg_perc)
```
...
1. Encompass your question and steps in reprex::reprex({ })
2. Include a link to your csv file or use sample data
3. Say what the error is 
